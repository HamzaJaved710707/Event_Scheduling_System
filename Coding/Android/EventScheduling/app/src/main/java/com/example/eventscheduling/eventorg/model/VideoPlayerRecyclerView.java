...
public class VideoPlayerRecyclerView extends RecyclerView {
     ...
     */
    // Media List
    private ArrayList<portfolio_video_values> mediaObjects = new ArrayList<>();
    ...
    public VideoPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        Log.d(TAG, "VideoPlayerRecyclerView: " + "init will be called soon");
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        Log.d(TAG, "init: is called in videoplayer recycler view");
        ...
        videoSurfaceView = new PlayerView(this.context);
            ...
            TrackSelector trackSelector = new DefaultTrackSelector(/* context= */ getContext(), trackSelectionFactory);
        ...
        DefaultTrackSelector.ParametersBuilder builder =
            ...
            videoPlayer =
                    new SimpleExoPlayer.Builder(/* context= */ getContext(), new DefaultRenderersFactory(getContext()))
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        Portfolio_Video_ViewHolder holder = (Portfolio_Video_ViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        ...
        mediaContainer = holder.media_container;
        videoSurfaceView.setPlayer(videoPlayer);
    ...
    public void setMediaObjects(ArrayList<portfolio_video_values> mediaObjects) {
