...
public class Resources {
    ...
    public static final portfolio_video_values[] MEDIA_OBJECTS = {
   */
/*         new portfolio_video_values("Sending Data to a New Activity with Intent Extras",
            ...
            new portfolio_video_values("REST API, Retrofit2, MVVM Course SUMMARY",
            ...
            new portfolio_video_values("MVVM and LiveData",
            ...
            new portfolio_video_values("Swiping Views with a ViewPager",
